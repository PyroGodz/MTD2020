...
namespace Parameter
{
	...
	{
		PARAMETER Parametr;
		wchar_t in[PARAMETER_MAX_SIZE], log[PARAMETER_MAX_SIZE], id[PARAMETER_MAX_SIZE], lx[PARAMETER_MAX_SIZE], rl[PARAMETER_MAX_SIZE], js[PARAMETER_MAX_SIZE];
		if (argc == 1)
		...
		if (argc <= 3) {
			...
			wcscpy_s(js, in);
			wcscat_s(js, PARAMETER_MAX_SIZE, PARAMETER_JS_FILE_EXTENSION);
			wcscpy_s(Parametr.js, js);
